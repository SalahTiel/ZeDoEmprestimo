    ...
    <section className={style.simulator}>
        ...
        <div className={style.proposal}>
                ...
                <select onChange={(e)=>{setMaritalStatus(e.target.value)}} name="Atividade profissional" id="">
                    ...
                    <option value="Servidor Público">Servidor(a) público(a)</option>
                    <option value="Agropecuarista">Agropecuarista</option>
                    <option value="Autônomo">Autônomo(a)</option>
                    <option value="Renda do capital">Renda do capital</option>
                ...
                {thirdProponent && secondProponent && (
                <>
                <div className={style.item}>
                ...
                <a onClick={()=>{setPopUpOpen(true)}} className={style.send}>Enviar Proposta</a>
            </form>
