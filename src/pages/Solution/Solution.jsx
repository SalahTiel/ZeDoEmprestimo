    ...
    <section className={style.simulator}>
        ...
        <form action="">
            ...
            <div className={style.item}>
                ...
                <input value={inputCredit} onChange={(e)=>{setInputCredit(e.target.value)}} name='credito' type="number" placeholder='entre R$50.000,00 e R$5.000.000,00'/>
            </div>
        </form>

        <div className={style.buttons}>
            <button onClick={()=>{setToggleProposal(!toggleProposal)}}>Incluir Proposta</button>
            <button onClick={()=>{setPopUpOpen(!popUpOpen)}}>Receber Contato</button>
        ...
        <div className={style.proposal}>
            ...
            <button className={style.send}>Enviar Proposta</button>
        </form>
        </div>
        </>)}
        ...
        <div className={style.contactPopUp}>
            <div onClick={()=>{setPopUpOpen(!popUpOpen)}} className={style.background}></div>
